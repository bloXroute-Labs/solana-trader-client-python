...
from helpers import Endpoint, call_place_order_bundle_paladin, \
    get_transaction, get_recent_blockhash, get_recent_blockhash_offset, get_rate_limit, get_account_balance, \
    get_jupiter_quotes, get_pump_fun_quotes, get_recent_blockhash_stream, get_block_stream, get_priority_fee, \
    get_priority_fee_stream, get_bundle_tip_stream, get_priority_fee_by_program_stream, get_token_accounts, \
    call_jupiter_trade_swap, call_pump_fun_trade_swap, create_personal_tx_and_submit, call_submit_snipe, \
...
ExampleEndpoints = {
    ...
    "get_pump_fun_new_amm_pool_stream": Endpoint(func=get_pump_fun_new_amm_pool_stream,
                                                  requires_additional_env_vars=False),
    "get_pump_fun_amm_swap_stream": Endpoint(func=get_pump_fun_amm_swap_stream,
                                                  requires_additional_env_vars=False),
